...
<script src='<?php echo site_url('js/jquery.stickOnScroll.js'); ?>'></script>
...
<script src='<?php echo site_url('assets/js/jquery.steps.min.js'); ?>'></script>
<script src='<?php echo site_url('assets/js/jquery.validate.min.js'); ?>'></script>
<script src='<?php echo site_url('assets/js/jquery.timepicker.js'); ?>'></script>
<script src='<?php echo site_url('assets/js/dropzone.min.js'); ?>'></script>
<script src='<?php echo site_url('assets/js/uppy.min.js'); ?>'></script>
<script src='<?php echo site_url('assets/js/quill.min.js'); ?>'></script>
<script>
  $('.select2').select2(
  {
    theme: 'bootstrap4',
