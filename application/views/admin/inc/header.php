...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo site_url('assets/css/uppy.min.css'); ?>">
    <link rel="stylesheet" href="<?php echo site_url('assets/css/jquery.steps.css'); ?>">
    <link rel="stylesheet" href="<?php echo site_url('assets/css/jquery.timepicker.css'); ?>">
    <link rel="stylesheet" href="<?php echo site_url('assets/css/quill.snow.css'); ?>">
