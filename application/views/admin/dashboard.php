            ...
            <div class="col-12">
              ...
              <div class="row mb-4 items-align-center">
                ...
                <div class="col-md-auto ml-auto text-right">
                  ...
                  <a href="<?php echo base_url('welcome/add'); ?>" class="btn mb-2 btn-outline-secondary">Add Medecine</a>
              ...
              <table class="table border table-hover bg-white">
                ...
                <tbody>
                  <?php foreach($obj->result() as $obj): ?>
                    ...
                    <td><?php echo $obj->id_obj; ?></td>
                    <td><?php echo $obj->purchaseDate; ?></td>
                    <td><?php echo $obj->name; ?></td>
                    <td><?php echo $obj->phone; ?></td>
                    <td><?php echo $obj->shipTo; ?></td>
                    ...
                    <td>
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                          <a class="dropdown-item" href="<?php echo base_url('welcome/edit/'.$obj->id_obj); ?>">Edit</a>
                          <a class="dropdown-item" href="<?php echo base_url('welcome/remove/'.$obj->id_obj); ?>">Remove</a>
